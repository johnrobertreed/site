...
A quiet, left-aligned single page: about, career, advisory, and a "How I can help" overlay with a mailto. Built to be fast, accessible, and easy to deploy. There is no visitor analytics or tracking.
...
Career entries are limited to roles JR provided. Uncertain or scraped items (Hotmail, GamePlan, internships) are omitted. There is no side-projects section, bookshelf, or portrait. The Whiskey For Water board seat is listed without a URL because the old domain could not be verified as live.
